...
# DB included 20201102
import json
import base64

from deployassets.utils.general import xyxy2xywh, xywh2xyxy, torch_distributed_zero_first
...
class LoadImages:  # for inference
    def __init__(self, path, img_size=640):
        ...
        self.video_flag = [False] * 1 + [True] * 0
        self.mode = 'images'
        if any(videos):
        ...
        assert self.nf > 0, 'No images or videos found in %s. Supported formats are:\nimages: %s\nvideos: %s' % \
                            ('Error coming from 1st load', img_formats, vid_formats)
    ...
    def __next__(self):
        ...
        return path, img, img0, self.cap, img0name
